...
internal class parmGPO2_if : UserControl
{
    private bool bool_0;
    ...
    internal parmGPO2_if(ref Class18 rm)
    {
        this.class18_0 = rm;
    ...
    private void InitializeComponent()
    {
            ...
            this.groupBox1.Text = "GPO 2 Fuel && Ignition Corrections:";
            // 
            // label3
            // 
            ...
            this.ctrlAdvTableFuel.Location = new System.Drawing.Point(79, 23);
            ...
            this.panel1.Size = new System.Drawing.Size(650, 136);
            ...
            this.Name = "parmGPO2_if";
            this.Size = new System.Drawing.Size(650, 136);
            this.Load += new System.EventHandler(this.parmGPO2_if_Load);
    ...
    {
        this.class18_0.method_156("GPO 2 Fuel Trim", false);
        if (dataGridViewCellValueEventArgs_0.RowIndex == 0)
        {
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_333 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3), this.class18_0.method_217(int.Parse(dataGridViewCellValueEventArgs_0.Value.ToString())));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_332 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2), this.class18_0.method_217(int.Parse(dataGridViewCellValueEventArgs_0.Value.ToString())));
        }
        else if (dataGridViewCellValueEventArgs_0.RowIndex == 1)
        {
            ...
            this.class18_0.method_151((this.class18_0.class13_u_0.long_333 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3)) + 1L, num);
        }
        else if (dataGridViewCellValueEventArgs_0.RowIndex == 2)
        {
            this.class18_0.method_149_SetByte((this.class18_0.class13_u_0.long_332 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2)) + 1L, this.class18_0.method_221(float.Parse(dataGridViewCellValueEventArgs_0.Value.ToString())));
        }
    ...
    private void method_1(DataGridViewCellValueEventArgs dataGridViewCellValueEventArgs_0)
    {
        if (dataGridViewCellValueEventArgs_0.RowIndex == 0)
        {
            dataGridViewCellValueEventArgs_0.Value = this.class18_0.method_187(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_332 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2)));
        }
        else if (dataGridViewCellValueEventArgs_0.RowIndex == 1)
        {
            int num = (int)this.class18_0.method_152((this.class18_0.class13_u_0.long_333 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3)) + 1L);
            if (num >= 0x8000)
            {
                num -= 0x8000;
        ...
        {
            dataGridViewCellValueEventArgs_0.Value = this.class18_0.method_189(this.class18_0.GetByteAt((this.class18_0.class13_u_0.long_332 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2)) + 1L)).ToString("0.00");
        }
    }
    ...
    private void method_6()
    {
        ...
        {
            this.parmGPO2_if_Load(null, null);
        }
    }

    private void parmGPO2_if_Load(object sender, EventArgs e)
    {
