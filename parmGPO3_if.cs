...
internal class parmGPO3_if : UserControl
{
    private bool bool_0;
    ...
    internal parmGPO3_if(ref Class18 rm)
    {
        this.class18_0 = rm;
    ...
    private void InitializeComponent()
    {
            ...
            this.groupBox1.Text = "GPO 3 Fuel && Ignition Corrections:";
            // 
            // label3
            // 
            ...
            this.ctrlAdvTableFuel.Location = new System.Drawing.Point(78, 24);
            ...
            this.Name = "parmGPO3_if";
            this.Size = new System.Drawing.Size(650, 131);
            this.Load += new System.EventHandler(this.parmGPO3_if_Load);
    ...
    {
        this.class18_0.method_156("GPO 3 Fuel Trim", false);
        if (dataGridViewCellValueEventArgs_0.RowIndex == 0)
        {
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_355 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3), this.class18_0.method_217(int.Parse(dataGridViewCellValueEventArgs_0.Value.ToString())));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_354 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2), this.class18_0.method_217(int.Parse(dataGridViewCellValueEventArgs_0.Value.ToString())));
        }
        else if (dataGridViewCellValueEventArgs_0.RowIndex == 1)
        {
            ...
            this.class18_0.method_151((this.class18_0.class13_u_0.long_355 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3)) + 1L, num);
        }
        else if (dataGridViewCellValueEventArgs_0.RowIndex == 2)
        {
            this.class18_0.method_149_SetByte((this.class18_0.class13_u_0.long_354 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2)) + 1L, this.class18_0.method_221(float.Parse(dataGridViewCellValueEventArgs_0.Value.ToString())));
        }
    ...
    private void method_1(DataGridViewCellValueEventArgs dataGridViewCellValueEventArgs_0)
    {
        if (dataGridViewCellValueEventArgs_0.RowIndex == 0)
        {
            dataGridViewCellValueEventArgs_0.Value = this.class18_0.method_187(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_355 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3)));
        }
        else if (dataGridViewCellValueEventArgs_0.RowIndex == 1)
        {
            int num = (int)this.class18_0.method_152((this.class18_0.class13_u_0.long_355 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 3)) + 1L);
            if (num >= 0x8000)
            {
                num -= 0x8000;
        ...
        {
            dataGridViewCellValueEventArgs_0.Value = this.class18_0.method_189(this.class18_0.GetByteAt((this.class18_0.class13_u_0.long_354 + (dataGridViewCellValueEventArgs_0.ColumnIndex * 2)) + 1L)).ToString("0.00");
        }
    }
    ...
    private void method_6()
    {
        ...
        {
            this.parmGPO3_if_Load(null, null);
        }
    }

    private void parmGPO3_if_Load(object sender, EventArgs e)
    {
