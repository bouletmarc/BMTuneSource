...
internal class parmGPO2_a : UserControl
{
    private bool bool_0;
    ...
    internal parmGPO2_a(ref Class18 rm)
    {
        this.class18_0 = rm;
        ...
        this.ctrlInputSelector1.method_Input_location(this.class18_0.class13_u_0.long_314);

        this.ctrlOutputSelector1.method_1(false);
        this.ctrlOutputSelector1.method_3(true);
        this.ctrlOutputSelector1.method_7(false);
        this.ctrlOutputSelector1.method_Output_location(this.class18_0.class13_u_0.long_316);
        ...
        this.groupBox1.Enabled = this.class18_0.method_265(new long[] { this.class18_0.class13_u_0.long_313, this.class18_0.class13_u_0.long_317 });
    ...
    private void InitializeComponent()
    {
            ...
            this.groupBox1.Text = "General Purpose Output 2";
            // 
            // groupBox2
            // 
            ...
            this.checkBox_0.Validated += new System.EventHandler(this.parmGPO2_Load);
            // 
            // chkMil
            // 
            ...
            this.chkMil.Validated += new System.EventHandler(this.parmGPO2_Load);
            // 
            // chkMaps
            // 
            ...
            this.chkMaps.Validated += new System.EventHandler(this.parmGPO2_Load);
            // 
            // chkEnable
            // 
            ...
            this.chkEnable.Validated += new System.EventHandler(this.parmGPO2_Load);
            // 
            // parmGPO2
            // 
            ...
            this.Load += new System.EventHandler(this.parmGPO2_Load);
    ...
    private void method_0(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_156("GPO 2 Settings", false);
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_324, byte_0);
            this.class18_0.method_153();
            this.parmGPO2_Load(null, null);
        }
    }
    ...
    private void method_1(byte byte_0)
    {
        ...
        {
            this.class18_0.method_156("GPO 2 Settings", false);
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_323, byte_0);
            this.class18_0.method_153();
            this.parmGPO2_Load(null, null);
        }
    }
    ...
    private void method_2(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 2 Output");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_316, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_3(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 2 Invert Output");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_317, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_4(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 2 Invert Input");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_315, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_5(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 2 Input");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_314, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_7()
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 2 Settings");
            if (this.chkEnable.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_313, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_313, 0);
            }
            if (this.checkBox_0.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_319, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_319, 0);
            }
            if (this.chkMaps.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_320, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_320, 0);
            }
            if (this.chkMil.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_318, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_318, 0);
            }
            this.class18_0.method_151(this.class18_0.class13_u_0.long_321, this.class18_0.method_219(int.Parse(this.txtbRpmMin.Text)));
            this.class18_0.method_151(this.class18_0.class13_u_0.long_322, this.class18_0.method_219(int.Parse(this.txtbRpmMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_325, this.class18_0.method_230(double.Parse(this.txtbEctMin.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_326, this.class18_0.method_230(double.Parse(this.txtbEctMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_327, this.class18_0.method_230(double.Parse(this.txtbIatMin.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_328, this.class18_0.method_230(double.Parse(this.txtbIatMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_329, this.class18_0.method_233(int.Parse(this.txtbVssMin.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_330, this.class18_0.method_233(int.Parse(this.txtbVssMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_331, this.class18_0.method_228(int.Parse(this.txtbTps.Text)));
            this.class18_0.method_153();
            this.parmGPO2_Load(null, null);
        }
    }

    private void parmGPO2_Load(object sender, EventArgs e)
    {
        if (this.groupBox1.Enabled)
        {
            ...
            this.chkEnable.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_313) == 0xff;
            this.ctrlOutputSelector1.method_10(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_316));
            this.ctrlOutputSelector1.method_1(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_317) == 0xff);
            this.ctrlInputSelector1.method_15(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_314));
            this.ctrlInputSelector1.method_5(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_315) == 0xff);
            this.checkBox_0.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_319) == 0xff;
            this.chkMaps.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_320) == 0xff;
            this.chkMil.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_318) == 0xff;
            this.txtbRpmMin.Text = this.class18_0.method_218(this.class18_0.method_152(this.class18_0.class13_u_0.long_321)).ToString();
            this.txtbRpmMax.Text = this.class18_0.method_218(this.class18_0.method_152(this.class18_0.class13_u_0.long_322)).ToString();
            this.ctrlMapValueMin.rawValue = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_323);
            this.ctrlMapValueMax.rawValue = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_324);
            this.txtbEctMin.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_325)).ToString();
            this.txtbEctMax.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_326)).ToString();
            this.txtbIatMin.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_327)).ToString();
            this.txtbIatMax.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_328)).ToString();
            this.txtbVssMin.Text = this.class18_0.method_197(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_329)).ToString();
            this.txtbVssMax.Text = this.class18_0.method_197(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_330)).ToString();
            this.txtbTps.Text = this.class18_0.method_198(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_331)).ToString();
