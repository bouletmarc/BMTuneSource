...
internal class parmGPO3_a : UserControl
{
    private bool bool_0;
    ...
    internal parmGPO3_a(ref Class18 rm)
    {
        this.class18_0 = rm;
        ...
        this.ctrlInputSelector1.method_Input_location(this.class18_0.class13_u_0.long_336);

        this.ctrlOutputSelector1.method_1(false);
        this.ctrlOutputSelector1.method_3(true);
        this.ctrlOutputSelector1.method_7(false);
        this.ctrlOutputSelector1.method_Output_location(this.class18_0.class13_u_0.long_338);
        ...
        this.groupBox1.Enabled = this.class18_0.method_265(new long[] { this.class18_0.class13_u_0.long_335, this.class18_0.class13_u_0.long_339 });
    ...
    private void InitializeComponent()
    {
            ...
            this.panel1.Size = new System.Drawing.Size(296, 456);
            ...
            this.groupBox1.Text = "General Purpose Output 3";
            // 
            // groupBox2
            // 
            ...
            this.groupBox5.Location = new System.Drawing.Point(7, 310);
            ...
            this.checkBox_0.Location = new System.Drawing.Point(6, 69);
            ...
            this.checkBox_0.Validated += new System.EventHandler(this.parmGPO3_Load);
            // 
            // chkMil
            // 
            this.chkMil.AutoSize = true;
            this.chkMil.Location = new System.Drawing.Point(6, 44);
            ...
            this.chkMil.Validated += new System.EventHandler(this.parmGPO3_Load);
            // 
            // chkMaps
            // 
            ...
            this.chkMaps.Validated += new System.EventHandler(this.parmGPO3_Load);
            // 
            // chkEnable
            // 
            ...
            this.chkEnable.Validated += new System.EventHandler(this.parmGPO3_Load);
            // 
            // parmGPO3
            // 
            ...
            this.Load += new System.EventHandler(this.parmGPO3_Load);
    ...
    private void method_0(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_156("GPO 3 Settings", false);
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_346, byte_0);
            this.class18_0.method_153();
            this.parmGPO3_Load(null, null);
        }
    }
    ...
    private void method_1(byte byte_0)
    {
        ...
        {
            this.class18_0.method_156("GPO 3 Settings", false);
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_345, byte_0);
            this.class18_0.method_153();
            this.parmGPO3_Load(null, null);
        }
    }
    ...
    private void method_2(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 3 Output");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_338, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_3(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 3 Invert Output");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_339, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_4(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 3 Invert Input");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_337, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_5(byte byte_0)
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 3 Input");
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_336, byte_0);
            this.class18_0.method_153();
        }
    }
    ...
    private void method_7()
    {
        if (!this.bool_0)
        {
            this.class18_0.method_155("GPO 3 Settings");
            if (this.chkEnable.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_335, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_335, 0);
            }
            if (this.checkBox_0.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_341, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_341, 0);
            }
            if (this.chkMaps.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_342, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_342, 0);
            }
            if (this.chkMil.Checked)
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_340, 0xff);
            }
            else
            {
                this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_340, 0);
            }
            this.class18_0.method_151(this.class18_0.class13_u_0.long_343, this.class18_0.method_219(int.Parse(this.txtbRpmMin.Text)));
            this.class18_0.method_151(this.class18_0.class13_u_0.long_344, this.class18_0.method_219(int.Parse(this.txtbRpmMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_347, this.class18_0.method_230(double.Parse(this.txtbEctMin.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_348, this.class18_0.method_230(double.Parse(this.txtbEctMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_349, this.class18_0.method_230(double.Parse(this.txtbIatMin.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_350, this.class18_0.method_230(double.Parse(this.txtbIatMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_351, this.class18_0.method_233(int.Parse(this.txtbVssMin.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_352, this.class18_0.method_233(int.Parse(this.txtbVssMax.Text)));
            this.class18_0.method_149_SetByte(this.class18_0.class13_u_0.long_353, this.class18_0.method_228(int.Parse(this.txtbTps.Text)));
            this.class18_0.method_153();
            this.parmGPO3_Load(null, null);
        }
    }

    private void parmGPO3_Load(object sender, EventArgs e)
    {
        if (this.groupBox1.Enabled)
        {
            ...
            this.chkEnable.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_335) == 0xff;
            this.ctrlOutputSelector1.method_10(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_338));
            this.ctrlOutputSelector1.method_1(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_339) == 0xff);
            this.ctrlInputSelector1.method_15(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_336));
            this.ctrlInputSelector1.method_5(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_337) == 0xff);
            this.checkBox_0.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_341) == 0xff;
            this.chkMaps.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_342) == 0xff;
            this.chkMil.Checked = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_340) == 0xff;
            this.txtbRpmMin.Text = this.class18_0.method_218(this.class18_0.method_152(this.class18_0.class13_u_0.long_343)).ToString();
            this.txtbRpmMax.Text = this.class18_0.method_218(this.class18_0.method_152(this.class18_0.class13_u_0.long_344)).ToString();
            this.ctrlMapValueMin.rawValue = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_345);
            this.ctrlMapValueMax.rawValue = this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_346);
            this.txtbEctMin.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_347)).ToString();
            this.txtbEctMax.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_348)).ToString();
            this.txtbIatMin.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_349)).ToString();
            this.txtbIatMax.Text = this.class18_0.method_191(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_350)).ToString();
            this.txtbVssMin.Text = this.class18_0.method_197(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_351)).ToString();
            this.txtbVssMax.Text = this.class18_0.method_197(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_352)).ToString();
            this.txtbTps.Text = this.class18_0.method_198(this.class18_0.GetByteAt(this.class18_0.class13_u_0.long_353)).ToString();
